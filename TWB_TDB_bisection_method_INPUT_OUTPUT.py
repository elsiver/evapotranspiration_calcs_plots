...
#ET = float(input("evapotranspiration per minute:")) #0.731875837596899 # g/m³KV pro minute

# HARDCODED
rel_hum = 55.1136 #%
t_air = 25.4775 # °C
ET = 1.8838 # g/m³KV pro minute
...
with open('results.csv', 'w') as csvfile:
    ...
    writer.writerow(['ETR,g/m³Xmin', 'MIN', 'tdb,°C', 'temp_depression,°C', 'twb,°C'])
...
#########################################################
        ...
        writer.writerow([ETR, MIN, tdb, temp_depression, twb])
